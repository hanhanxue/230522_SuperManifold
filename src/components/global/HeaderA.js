...
// <header className={`${styles.section}`}> {/* SECTION */}
// <div className={`${styles.xFrame}`}> {/* X Frame */}
// <div className={`${styles.yFrame}`}> {/* Y Frame */}

//     <div className={`${styles.container}`}>
//     <Link href="/"><h2 className={`brand-base`}>Super Manifold®</h2></Link>


//     <nav className={`${styles.nav}`}>
//         <ul className={`brand-base ${styles.navList}`}> 
//             <li>Work</li>
//             <li>Studio</li>
//             <li>Let's chat</li>
//         </ul>
...
// <div className={`${styles.navGridContainer}`}></div>
...
// {/* TILE */}
// <div className={`${styles.tile} ${styles.tile_2c_1r}`}>
//     <h2 className={`brand-xl ${styles.tileLabel} `}>Work</h2>
// </div>
// {/* TILE */}
// <div className={`${styles.tile} ${styles.tile_1c_1r}`}>
//     <h2 className={`brand-xl ${styles.tileLabel} `}>Studio</h2>
// </div>
// {/* TILE */}
// <div className={`${styles.tile} ${styles.tile_2c_2r}`}>
//     <h2 className={`brand-xl ${styles.tileLabel} `}>Contact</h2>
//     <div className={`${styles.tileCopy} `}>
//         <ul className={`brand-base `}>
//             <li>
...
// <div className={`${styles.tile} ${styles.footer}`}>
//     <span className={`brand-base`}>©2023 Build by Han Han Xue</span>
//     <ul className={`brand-base `}>
//         <li>Github</li>
//         <li>Instagram</li>
//         <li>LinkedIn</li>
